...
add_action( 'after_setup_theme', 'hockey_custom_header_setup' );

if ( ! function_exists( 'hockey_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see hockey_custom_header_setup().
 */
function hockey_header_style() {
...
endif; // hockey_header_style

if ( ! function_exists( 'hockey_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see hockey_custom_header_setup().
 */
function hockey_admin_header_style() {
?>
	<style type="text/css">
...
endif; // hockey_admin_header_style

if ( ! function_exists( 'hockey_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see hockey_custom_header_setup().
 */
function hockey_admin_header_image() {
...
endif; // hockey_admin_header_image